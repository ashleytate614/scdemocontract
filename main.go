...
//go:generate go run /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/go/iotcontractplatform/scripts/processSchema.go
...
func main() {
	iot.SetContractLogger(shim.NewLogger("veticalsupplychain"))
